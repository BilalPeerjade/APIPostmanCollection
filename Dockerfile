...
COPY GoRestEnv.postman_environment_new.json .

# Set the command to run Newman and execute your Postman collection
CMD ["newman", "run", "GoRestAPIWorkFlow.postman_collection_new.json", "-e", "GoRestEnv.postman_environment_new.json", "-r", "cli,json,html,htmlextra"]
